...
export function Countdown() {
  ...
  const [minuteLeft, minuteRight] = String(minutes).padStart(2, "0").split(""); //padStart verifica se um numero consegue ser dividido em dois, caso contrário, ele insere um numero a esquerda
